<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="id" label="入库单据号" width="120"></el-table-column>
      ...
      <el-table-column prop="number" label="入库数量" width="150"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    del(id){
      this.request.delete("/in/"+id).then(res=>{
        if(res.code === '200'){
    ...
    delBatch(){
      ...
      this.request.post("/in/del/batch", ids).then(res=>{
        if(res.code === '200'){
