    ...
    <div style="margin: 100px auto; background-color: #fff; width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="nickname">
          <el-input placeholder="请输入昵称" size="medium" style="margin: 5px 0" prefix-icon="el-icon-edit" v-model="user.nickname"></el-input>
        </el-form-item>
...
<style>
  .wrapper {
    height: 100vh;
    background-image: linear-gradient(to bottom right, #D746FC , #3FFBDC);
    overflow: hidden;
  }
</style>