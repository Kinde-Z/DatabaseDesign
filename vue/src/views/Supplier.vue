<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="name" label="供应商名称" width="320"></el-table-column>
      <el-table-column prop="phone" label="供应商电话" width="200"></el-table-column>
      <el-table-column prop="address" label="供应商地址" width="200"></el-table-column>
